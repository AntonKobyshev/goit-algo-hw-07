...
b_tree.add(10, "Toyota")
b_tree.add(7, "Honda")
b_tree.add(8, "BMW")  
b_tree.add(11, "Mercedes")
b_tree.add(9, "Ford")
b_tree.add(7, "Chevrolet")
b_tree.add(12, "Tesla")  

#Results output
print("Show tree", b_tree, sep="\n")
print("The sum of the keys of the vertices:", b_tree.sum())  
print("Binary smallest node:", b_tree.find_smallest_node())  
print("Binary biggest node:", b_tree.find_biggest_node())  
